...
public class CustomerNameActivity extends AppCompatActivity implements View.OnClickListener {
    String email, password,mydate,code,customerphone,customername;
    EditText name;
    Button profile1;
    TextView bug;
    ...
    public void generatecode() {
        ...
        if (resultUri != null) {
            Intent myintent = new Intent(CustomerNameActivity.this, CustomerInviteActivity.class);
            ...
            myintent.putExtra("customerphonenumber",customerphone);
