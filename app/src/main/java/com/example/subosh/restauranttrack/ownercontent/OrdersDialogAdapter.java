...
public class OrdersDialogAdapter extends RecyclerView.Adapter<OrdersDialogAdapter.MyHolder> {
    Context context;
    ...
    public OrdersDialogAdapter(Context context, ArrayList<CustomerOrdersPojo> customerOrderDetails,float grandtotal) {
